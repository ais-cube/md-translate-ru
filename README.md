...
`run.py` покажет интерактивное меню: найдет файлы, спросит язык (11 пар), покажет прогноз стоимости, переведет и соберет результат в выбранные форматы.
...
| `ModuleNotFoundError: fpdf` | `pip install fpdf2 markdown` |
...
- Python 3.10+
- Пакет [anthropic](https://pypi.org/project/anthropic/) >= 0.40.0 (для перевода)
- Пакеты [fpdf2](https://pypi.org/project/fpdf2/), [markdown](https://pypi.org/project/markdown/) (для конвертации)
